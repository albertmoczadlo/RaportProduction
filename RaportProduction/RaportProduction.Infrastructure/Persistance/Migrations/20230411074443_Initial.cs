        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartProductionTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndProductionTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberTanks = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterDataTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeEvents_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfDismissal = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductionTimeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Raports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Raports_ProductionTimes_ProductionTimeId",
                        column: x => x.ProductionTimeId,
                        principalTable: "ProductionTimes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Raports_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Raports_Tanks_TankId",
                        column: x => x.TankId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 11, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod testowy- ogłoszenie" },
                    { 2, new DateTime(2022, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod testowy 2- ogłoszenie" },
                    { 3, new DateTime(2022, 9, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod testowy 3- ogłoszenie" },
                    { 4, new DateTime(2022, 10, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod testowy 4- ogłoszenie" },
                    { 5, new DateTime(2022, 12, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod testowy 5- ogłoszenie" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, "Nazwa nadawcy", "SenderName", 5, 1, 0, "Jan Kowalski" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Raports_ProductId",
                table: "Raports",
                column: "ProductId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Raports_ProductionTimeId",
                table: "Raports",
                column: "ProductionTimeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Raports_TankId",
                table: "Raports",
                column: "TankId",
                unique: true);
